...
#ifdef _SPECPOWER
	s.specColor = SpecularPower(s.specColor);
#endif
...
#ifndef LIGHTMAP_OFF
	float lSpecularCoeff = 1.0 - Luminance(DecodeLightmap(UNITY_SAMPLE_TEX2D(unity_Lightmap, i.ambientOrLightmapUV.xy)));
	s.specColor *= lSpecularCoeff;
#endif
#ifdef _SPECPOWER
	s.specColor = SpecularPower(s.specColor);
#endif
