...
public class BkStandardShaderGUI : ShaderGUI
{
	...
	private static class Styles
	{
		...
		public static GUIContent specularPowerText = new GUIContent("Specular Power", "Specular power factor");
	...
	void DoSpecularMetallicArea()
	{
		...
		--indentation;
		if (m_WorkflowMode == WorkflowMode.Specular)
			m_MaterialEditor.ShaderProperty(specularPower, Styles.specularPowerText, indentation);
	}
	...
	static void SetMaterialKeywords(Material material, WorkflowMode workflowMode)
	{
		...
		if (workflowMode == WorkflowMode.Specular)
		{
			...
			SetKeyword (material, "_SPECPOWER", material.GetFloat ("_SpecPower") != 1.0f);
		}
